...
type FormatChatResponse struct {
	Model           string        `json:"model"`
	CreatedAt       time.Time     `json:"created_at"`
	FormattedPrompt string        `json:"string"`
	Images          []Base64Image `json:"Base64Image,omitempty"`
	DoneReason      string        `json:"done_reason,omitempty"`
...
type TokenizeResponse struct {
	...
	CreatedAt time.Time `json:"created_at"`
	// Tokens is the list of tokens generated by the model.
...
type FormatAndTokenizeResponse struct {
	// Model is the model name that generated the response.
	Model string `json:"model"`
	// CreatedAt is the timestamp of the response.
	CreatedAt time.Time `json:"created_at"`
	// FormattedPrompt is the formatted prompt generated by the model.
...
// Metrics contains various metrics about the request and response, such as
